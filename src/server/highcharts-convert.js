...
(function() {
        ...
        createChart = function(constr, input, globalOptionsArg, dataOptionsArg, customCodeArg, outputType, callback, messages) {
            ...
            if (dataOptions) {
                ...
                try {
                    ...
                    console.log('chart constructor does not exist(constr : ' + constr + ')');
                    chart = new Highcharts['Chart'](options, cb);
                }
            }
    ...
    startServer = function(host, port) {
        ...
        console.log("[" + new Date().toLocaleString() + "] OK, PhantomJS is ready.");
    };
